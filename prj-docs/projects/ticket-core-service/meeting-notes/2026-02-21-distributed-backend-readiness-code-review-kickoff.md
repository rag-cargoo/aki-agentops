...
> - **Updated At**: `2026-02-22 06:34:45`
> - **Target**: `BOTH`
> - **Surface**: `PUBLIC_NAV`
<!-- DOC_META_END -->
...
- 원칙:
  ...
  - 즉시 구조개편은 하지 않고, 이전 진행 중 작업 마무리 후 이 안건을 별도 트랙으로 진행한다.
...
- 남은 것:
  - 체크리스트 기준 상세 코드리뷰 실행
  - 발견 이슈를 제품 레포 이슈/PR 단위로 분해
  - 클릭 기반 Redis soft lock과 좌석 확정(DB HOLD) 경계에 대한 API/상태머신 상세 계약서 작성
