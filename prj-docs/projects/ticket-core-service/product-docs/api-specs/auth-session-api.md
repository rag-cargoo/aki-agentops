# Auth Session API Specification (Auth Track A2) (Pages Mirror)
...
## Source
- Upstream: [ticket-core-service/prj-docs/api-specs/auth-session-api.md](https://github.com/rag-cargoo/ticket-core-service/blob/main/prj-docs/api-specs/auth-session-api.md)
