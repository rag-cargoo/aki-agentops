# Reservation API Specification & Integration Guide (Pages Mirror)
...
## Source
- Upstream: [ticket-core-service/prj-docs/api-specs/reservation-api.md](https://github.com/rag-cargoo/ticket-core-service/blob/main/prj-docs/api-specs/reservation-api.md)
