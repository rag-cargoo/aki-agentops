# Social Auth API Specification (Pages Mirror)
...
## Source
- Upstream: [ticket-core-service/prj-docs/api-specs/social-auth-api.md](https://github.com/rag-cargoo/ticket-core-service/blob/main/prj-docs/api-specs/social-auth-api.md)
