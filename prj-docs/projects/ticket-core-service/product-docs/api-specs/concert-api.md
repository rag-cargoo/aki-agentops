# Concert API Specification (Pages Mirror)
...
## Source
- Upstream: [ticket-core-service/prj-docs/api-specs/concert-api.md](https://github.com/rag-cargoo/ticket-core-service/blob/main/prj-docs/api-specs/concert-api.md)
