...
* **🏗️ Default Service (Backend)**
  * **Status & Planning**
    * [🗺️ 개발 로드맵 (Roadmap)](workspace/apps/backend/default-service/prj-docs/ROADMAP.md)
    * [✅ 현재 작업 (Tasks)](workspace/apps/backend/default-service/prj-docs/task.md)
  * **Engineering Knowledge**
    * [⚙️ 동시성 제어 전략](workspace/apps/backend/default-service/prj-docs/knowledge/동시성-제어-전략.md)
