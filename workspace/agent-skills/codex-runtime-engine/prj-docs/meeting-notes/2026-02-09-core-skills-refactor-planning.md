...
## 안건 9: workspace-governance 제거 및 소유 스킬 분산
- Created At: 2026-02-09 19:01:53
- Updated At: 2026-02-09 19:01:53
- Status: DONE
- 결정사항:
  - `skills/workspace-governance`는 제거한다.
...
- 후속작업:
  ...
  - 기한: 2026-02-10
  - 상태: DONE
  - 진행기록: 파일 이관 + 참조 경로 교체 + `skills/workspace-governance` 삭제 + 실행 검증(session_start/check-skill-naming/quick+strict/run-skill-hooks) 완료
