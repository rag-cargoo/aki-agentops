...
public class QSeat extends EntityPathBase<Seat> {
    ...
    private static final long serialVersionUID = -437372293L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QSeat seat = new QSeat("seat");

    public final QConcertOption concertOption;
    ...
    public QSeat(Class<? extends Seat> type, PathMetadata metadata, PathInits inits) {
        ...
        this.concertOption = inits.isInitialized("concertOption") ? new QConcertOption(forProperty("concertOption"), inits.get("concertOption")) : null;
    }
